/*
  This command is used to create a new SLP non-fungible token (NFT).
  Creating an NFT consumes a Group token. See this link for more information:
